  ...
  return (
    <main className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 pt-20 pb-16 px-4">
        <article className="min-h-screen text-gray-800 dark:text-gray-100 mx-auto max-w-5xl">
          {/* Hero Section */}
            ...
            <div className="relative max-w-4xl mx-auto px-4 py-1">
              <div className="text-center">
                <div className="flex items-center justify-center gap-3 mb-4 animate-fadeIn">
                  <h1 className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-blue-600 dark:from-purple-400 dark:to-blue-400 animate-fadeIn">
                    {aboutT.hero.title}
                  </h1>
                </div>
                <p
          ...
          <div className="max-w-4xl mx-auto px-6 py-16">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="group p-6 rounded-xl glass-card border border-gray-300 dark:border-gray-700/30 hover:border-purple-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/20 bg-white/80 dark:bg-gray-900/50">
              ...
              {/* Mood-Based Search */}
              <div className="group p-6 rounded-xl glass-card border border-gray-300 dark:border-gray-700/30 hover:border-blue-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/20 bg-white/80 dark:bg-gray-900/50">
                <div className="flex items-start gap-4">
              ...
              {/* User Authentication */}
              <div className="group p-6 rounded-xl glass-card border border-gray-300 dark:border-gray-700/30 hover:border-yellow-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-yellow-500/20 bg-white/80 dark:bg-gray-900/50">
                <div className="flex items-start gap-4">
              ...
              <div className="group p-6 rounded-xl glass-card border border-gray-300 dark:border-gray-700/30 hover:border-pink-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-pink-500/20 bg-white/80 dark:bg-gray-900/50">
                <div className="flex items-start gap-4">
              ...
              {/* Movie Database */}
              <div className="group p-6 rounded-xl glass-card border border-gray-300 dark:border-gray-700/30 hover:border-red-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-red-500/20 bg-white/80 dark:bg-gray-900/50">
                <div className="flex items-start gap-4">
              ...
              {/* Detailed Movie Info */}
              <div className="group p-6 rounded-xl glass-card border border-gray-300 dark:border-gray-700/30 hover:border-cyan-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-cyan-500/20 bg-white/80 dark:bg-gray-900/50">
                <div className="flex items-start gap-4">
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  <div className="flex items-center space-x-4 p-4 rounded-xl glass-card border border-gray-300 dark:border-gray-700/30 bg-white/80 dark:bg-gray-900/50">
